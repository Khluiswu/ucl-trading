/** Single source of truth for the society's public contact points. */
...
export const SOCIETY_LINKS = {
  ...
  linkedin: "https://www.linkedin.com/company/ucl-trading-soc/",
  instagram: "https://www.instagram.com/ucltradingsoc/",
} as const;
